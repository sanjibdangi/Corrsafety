...
import team1 from 'figma:asset/773b4690154d4e60549b2c5cc11cf94ab2857027.png';
  ...
  return (
    <section id="team" ref={ref} className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="bg-white rounded-xl p-6 text-center shadow-lg border border-slate-100">
