  ...
  const milestones = [
    {
      ...
      description: 'Corr Safety Professionals established in Pennsylvania',
    ...
    },
    {
      ...
      description: 'Achieved Certified Safety Professional leadership',
      color: 'from-emerald-500 to-emerald-600',
    },
    {
      year: '2023',
      icon: TrendingUp,
      title: 'GSA Contract Awarded',
      description: 'Secured GSA MAS Contract 47QRAA25D000N',
    ...
    },
    {
      ...
      description: 'Leading industry safety standards and innovation',
