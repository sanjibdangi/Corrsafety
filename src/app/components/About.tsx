  ...
  const features = [
    {
      ...
      description: 'Comprehensive EHS solutions',
    },
    {
      icon: Award,
      title: 'Certified Team',
      description: 'Led by CSPs with proven expertise',
    },
    {
      icon: Target,
      title: 'Compliance Focus',
      description: 'OSHA, ISO, and API standards',
    },
    {
      icon: TrendingUp,
      title: 'Continuous Growth',
      description: 'Driving operational improvement',
    },
  ];
          ...
          >
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-slate-100">
              ...
              <p className="text-lg text-slate-700 leading-relaxed">
                ...
                data-driven safety strategies that foster strong safety cultures. Corr Safety works with contractors,
                energy producers, and industrial firms to enhance workplace safety, improve leadership accountability,
