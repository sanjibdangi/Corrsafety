...
export function Contact() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      label: 'Phone',
      value: '(610) 223-1946',
      link: 'tel:+16102231946',
    },
    {
      icon: Mail,
      label: 'Email',
      value: 'dmitchell@corrsafety.com',
      link: 'mailto:dmitchell@corrsafety.com',
    },
    {
      icon: Globe,
      label: 'Website',
      value: 'www.corrsafety.com',
      link: 'https://www.corrsafety.com',
    },
    {
      icon: MapPin,
      label: 'Address',
      value: '2 Market Street, West Chester, PA 19380',
    },
  ];
                    ...
                    <div key={index} className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        {info.link ? (
                          <a
                            href={info.link}
                            className="text-slate-900 hover:text-emerald-600 transition-colors font-medium"
                          >
                            {info.value}
                          </a>
                        ) : (
              ...
              <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-lg">
                ...
                <div className="flex flex-wrap gap-2">
                  {naicsCodes.map((code, index) => (
                    <span
                      key={index}
                      className="px-3 py-1 bg-slate-100 rounded-lg text-sm font-mono text-slate-700 border border-slate-200"
                    >
                      {code}
                    </span>
                  ))}
