...
export function PastPerformance() {
  ...
  const projects = [
    ...
    },
    {
      ...
      value: 75,
      suffix: '+',
      description: 'Clean energy sites managed',
    ...
    },
    {
      ...
      value: 200,
      suffix: '+',
      description: 'Critical facilities secured',
  ...
  return (
    <section id="past-performance" className="py-20 bg-white">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <motion.div
                ...
                className="bg-white border border-emerald-200 rounded-lg px-4 py-3 text-center text-slate-700 hover:border-emerald-500 hover:text-emerald-600 hover:shadow-md transition-all duration-300"
              >
                {industry}
              </motion.div>
            ))}
