...
import diffImage from 'figma:asset/2fb4f921f4c23dcce206f93d1f9935f33382f92b.png';
  ...
  const differentiators = [
    {
      ...
      description: 'Owned & operated by a Certified Safety Professional (CSP) with 16+ years of industry experience',
      color: 'from-blue-500 to-blue-600',
    },
    {
      icon: Users,
      title: 'Field-Proven Experts',
      description: 'Field-proven EHS consultants across high-risk industries',
      color: 'from-emerald-500 to-emerald-600',
    },
    {
      icon: Settings,
      title: 'Customizable Programs',
      description: 'Customizable safety training and site-specific management programs',
      color: 'from-purple-500 to-purple-600',
    },
    {
      icon: FileCheck,
      title: 'GSA MAS Contract',
      description: 'Active GSA MAS Contract: 47QRAA25D000N (valid through 2044)',
      color: 'from-orange-500 to-orange-600',
    },
    {
      icon: Star,
      title: 'Proven Track Record',
      description: 'Proven record with major clients including SunPower & AIM Mechanical',
      color: 'from-pink-500 to-pink-600',
    },
    {
      icon: CheckCircle,
      title: 'Compliance Expertise',
      description: 'Expertise in OSHA, ISO 14001, and API compliance frameworks',
          ...
          <div className="order-1 lg:order-2 space-y-4">
            {differentiators.map((diff, index) => (
              <motion.div
                ...
                className="bg-slate-50 rounded-xl p-6 hover:bg-white hover:shadow-lg transition-all duration-300 border border-slate-100"
              >
